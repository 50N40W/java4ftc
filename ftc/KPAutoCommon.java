...
public class KPAutoCommon {
    ...
    static void autoTasks(RobotKP robot, Structures aSet)
    {
        ...
        while (autoState < 5) 
        {
        	...
        	if (prevSec != currentTime) {
        		System.out.printf("line76 %.8f\n",(float)prevSec);
        		prevSec = currentTime;
        	}
	        ...
	        if (currentTime - lastSensor > RobotKP.MINOR_FRAME) {
	            ...
	            currentHeading = myRobot.gyro.getHeading();
	        }
	        ...
	        if (currentTime - lastNav > RobotKP.MINOR_FRAME)
	        {
	            ...
	            String s1 = String.format("%, d", autoState);
	            String s2 = String.format("%, .8f",(float)currentTime);
	            System.out.print(s1);
